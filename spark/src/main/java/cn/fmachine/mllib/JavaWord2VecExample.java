 ...
 * Please refer to the MLlib user guide on Word2Vec for more details.
 * <p>
 * Examples
 * <p>
 * In the following code segment, we start with a set of documents,
 * each of which is represented as a sequence of words.
 * For each document, we transform it into a feature vector.
 * This feature vector could then be passed to a learning algorithm.
 */
